...
import (
	...
	"fmt"
	"strings"
	hasher "github.com/dindinw/dagproject/encode/hash160"
	btcec "github.com/dindinw/dagproject/crypto/ec_secp256k1"
	"github.com/dindinw/dagproject/encode/base58"
	"github.com/dindinw/dagproject/encode/bech32"
	"github.com/dindinw/dagproject/chaincfg_btc"
...
func NewAddressScriptHash(serializedScript []byte, net *chaincfg.Params) (*AddressScriptHash, error) {
	scriptHash := hasher.Hash160(serializedScript)
...
func (a *AddressPubKey) EncodeAddress() string {
	return encodeAddress(hasher.Hash160(a.serialize()), a.pubKeyHashID)
}
...
func (a *AddressPubKey) AddressPubKeyHash() *AddressPubKeyHash {
	...
	copy(addr.hash[:], hasher.Hash160(a.serialize()))
	return addr
}
