...
import (
	...
	"github.com/dindinw/dagproject/merkletree/hasher"
)
...
func referenceMerkleTreeHash(inputs [][]byte, treehasher hasher.LogHasher) ([]byte, error) {
	if len(inputs) == 0 {
...
func referenceMerklePath(inputs [][]byte, leaf int64, treehasher hasher.LogHasher) ([][]byte, error) {
	var path [][]byte
...
func referenceSnapshotConsistency(inputs [][]byte, snapshot2 int64,
	snapshot1 int64, treehasher hasher.LogHasher, haveRoot1 bool) ([][]byte, error) {
