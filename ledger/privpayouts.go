...
func initPriv() {
	...
	addPayoutLock(addrS, types.Amount{Value: 500 * types.AtomsPerCoin, Id: types.MEERID}, "76a91437733b37b9f09ce024a5ffbd4570fc1e242c907a88acc90480286f60", 1617897600)

	// lock 2022-04-09 1649433600 txscript.PayToAddrLockScript(addr,1649433600)
	addPayoutLock(addrS, types.Amount{Value: 500 * types.AtomsPerCoin, Id: types.QITID}, "76a91437733b37b9f09ce024a5ffbd4570fc1e242c907a88acc904005c5062", 1649433600)
}
