...
func TestStatusValid(t *testing.T) {
	...
	} else if badStatus := Status(math.MaxUint8); badStatus.Valid() == nil {
...
func TestStatusDecided(t *testing.T) {
	...
	} else if badStatus := Status(math.MaxUint8); badStatus.Decided() {
...
func TestStatusFetched(t *testing.T) {
	...
	} else if badStatus := Status(math.MaxUint8); badStatus.Fetched() {
...
func TestStatusString(t *testing.T) {
	...
	} else if badStatus := Status(math.MaxUint8); badStatus.String() != "Invalid status" {
