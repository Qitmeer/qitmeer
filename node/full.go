...
func (nox *NoxFull) AnnounceNewTransactions(newTxs []*types.Tx) {
...
func (nox *NoxFull) RelayInventory(invVect *message.InvVect, data interface{}) {
	// TODO p2p layer
	/*
