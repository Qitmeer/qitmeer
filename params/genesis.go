		...
		TxIn: []*types.TxInput{
			{
				...
				SignScript: []byte{
					...
					0x6e, 0x61, 0x20, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x29, 0x20,
					0x32, 0x30, 0x31, 0x39, 0x2f, 0x31, 0x32, 0x2f, 0x33, 0x30, 0x0a,
...
var testNetGenesisBlock = types.Block{
	Header: types.BlockHeader{
		...
		Timestamp:  time.Unix(1577264400,0), // 2019-12-25 09:00:00 GMT
