...
type BlockData struct {
	DagID                uint32   `protobuf:"varint,1,opt,name=dagID,proto3" json:"dagID,omitempty"`
	BlockBytes           []byte   `protobuf:"bytes,2,opt,name=blockBytes,proto3" json:"blockBytes,omitempty" ssz-max:"1048576"`
...
func (m *BlockData) GetDagID() uint32 {
	if m != nil {
		return m.DagID
	}
	return 0
...
var fileDescriptor_ed45aea3b866f95b = []byte{
	...
	0x2a, 0x4d, 0x03, 0xf3, 0xc0, 0x1c, 0x30, 0x0b, 0xa2, 0x5d, 0x29, 0x82, 0x8b, 0xd3, 0x09, 0x64,
	0x9c, 0x4b, 0x62, 0x49, 0xa2, 0x90, 0x08, 0x17, 0x6b, 0x4a, 0x62, 0xba, 0xa7, 0x8b, 0x04, 0xa3,
	0x02, 0xa3, 0x06, 0x6f, 0x10, 0x84, 0x23, 0x64, 0xca, 0xc5, 0x05, 0xb6, 0xd1, 0xa9, 0xb2, 0x24,
	0xb5, 0x58, 0x82, 0x49, 0x81, 0x51, 0x83, 0xc7, 0x49, 0xf4, 0xd3, 0x3d, 0x79, 0xc1, 0xe2, 0xe2,
	0x2a, 0xdd, 0xdc, 0xc4, 0x0a, 0x2b, 0x25, 0x43, 0x03, 0x13, 0x0b, 0x53, 0x73, 0x33, 0xa5, 0x20,
	0x24, 0x85, 0x4e, 0x02, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0, 0x91, 0x1c,
	0xe3, 0x8c, 0xc7, 0x72, 0x0c, 0x49, 0x6c, 0x60, 0x2b, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff,
	0xd8, 0x81, 0x95, 0x97, 0xc4, 0x00, 0x00, 0x00,
}
...
func (m *BlockData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DagID != 0 {
		i = encodeVarintGetblocks(dAtA, i, uint64(m.DagID))
		i--
		dAtA[i] = 0x8
	}
...
func (m *BlockData) Size() (n int) {
	...
	_ = l
	if m.DagID != 0 {
		n += 1 + sovGetblocks(uint64(m.DagID))
	}
	l = len(m.BlockBytes)
	if l > 0 {
