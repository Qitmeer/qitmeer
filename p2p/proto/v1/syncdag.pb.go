...
type SubDAG struct {
	...
	GraphState           *GraphState `protobuf:"bytes,2,opt,name=graphState,proto3" json:"graphState,omitempty"`
	BlockBytes           []byte      `protobuf:"bytes,3,opt,name=blockBytes,proto3" json:"blockBytes,omitempty" ssz-max:"1048576"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *SubDAG) GetBlockBytes() []byte {
	if m != nil {
		return m.BlockBytes
	}
	return nil
...
var fileDescriptor_9cb77bcde7ac0e2c = []byte{
	...
	0x1b, 0x49, 0xa1, 0x1b, 0xe4, 0x0e, 0x57, 0x11, 0x84, 0xa4, 0x5a, 0x69, 0x3d, 0x23, 0x17, 0x5b,
	0x70, 0x69, 0x12, 0xc8, 0x41, 0x46, 0x5c, 0x9c, 0xa0, 0xe0, 0x08, 0xc8, 0xcf, 0xcc, 0x2b, 0x91,
	0x60, 0x04, 0x9b, 0x82, 0xd5, 0x39, 0x41, 0x08, 0x65, 0x94, 0x58, 0x2d, 0x64, 0xca, 0xc5, 0x95,
	0x94, 0x93, 0x9f, 0x9c, 0xed, 0x54, 0x59, 0x92, 0x5a, 0x2c, 0xc1, 0xac, 0xc0, 0xa8, 0xc1, 0xe3,
	0x24, 0xfa, 0xe9, 0x9e, 0xbc, 0x20, 0xdc, 0xa7, 0x86, 0x06, 0x26, 0x16, 0xa6, 0xe6, 0x66, 0x4a,
	0x41, 0x48, 0x0a, 0x9d, 0x04, 0x4e, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23,
	0x39, 0xc6, 0x19, 0x8f, 0xe5, 0x18, 0x92, 0xd8, 0xc0, 0x81, 0x6b, 0x0c, 0x08, 0x00, 0x00, 0xff,
	0xff, 0xa9, 0xc9, 0x32, 0x65, 0xce, 0x01, 0x00, 0x00,
}
...
func (m *SubDAG) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BlockBytes) > 0 {
		...
		i = encodeVarintSyncdag(dAtA, i, uint64(len(m.BlockBytes)))
		i--
		dAtA[i] = 0x1a
	}
	if m.GraphState != nil {
