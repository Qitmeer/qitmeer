...
// types.MsgMerkleBlock according to a filter.
...
// NewMerkleBlock returns a new *types.MsgMerkleBlock and an array of the matched
// transaction index numbers based on the passed block and filter.
func NewMerkleBlock(block *types.SerializedBlock, filter *Filter) (*types.MsgMerkleBlock, []uint32) {
	...
	msgMerkleBlock := types.MsgMerkleBlock{
