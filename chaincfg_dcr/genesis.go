...
// the test network.
var genesisCoinbaseTxLegacy = MsgTx{
	SerType: TxSerializeFull,
	Version: 1,
	TxIn: []*TxIn{
		{
...
var testNet2GenesisBlock = MsgBlock{
	Header: BlockHeader{
		Version:      4,
		PrevBlock:    chainhash.Hash{},
	...
	Transactions: []*MsgTx{&genesisCoinbaseTxLegacy},
}
...
var regTestGenesisCoinbaseTx = MsgTx{
	SerType: TxSerializeFull,
	Version: 1,
	TxIn: []*TxIn{
		{
...
var simNetGenesisBlock = MsgBlock{
	Header: BlockHeader{
		Version: 1,
	...
	Transactions:  []*MsgTx{&regTestGenesisCoinbaseTx},
	STransactions: []*MsgTx{},
}
