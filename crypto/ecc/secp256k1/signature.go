...
// Note: the serialized bytes returned do not include the appended hash
// type used in the signature scripts.
//
...
// case in step 1.6. This counter is used in the compressed signature format and
// match bitcoin core's behaviour here.
