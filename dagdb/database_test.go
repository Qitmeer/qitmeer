...
func newTestLDB() (*dagdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "dag_db_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := dagdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db dagdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db dagdb.Database, t *testing.T) {
	const n = 8
