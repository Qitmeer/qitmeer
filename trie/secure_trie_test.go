...
func newEmptySecure() *SecureTrie {
	trie, _ := NewSecure(hash.Hash{}, NewDatabase(statedb.NewMemDatabase()), 0)
	return trie
}
...
func TestSecureDelete(t *testing.T) {
	...
	h := trie.Hash()
	exp := hash.MustHexToHash("29b235a58c3c25ab83010c327d5932bcf05324b7d6b1185e650798034783ca9d")
	if h != exp {
